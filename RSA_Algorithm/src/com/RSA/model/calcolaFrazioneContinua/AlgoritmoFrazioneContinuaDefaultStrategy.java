...
public class AlgoritmoFrazioneContinuaDefaultStrategy implements IAlgoritmoFrazioneContinuaStrategy {
	...
	public List<RisultatoIterazioneCalcoloFrazioneContinua> calcolaFrazioneContinua(Frazione frazione) {
		...
		*/ 
		...
		risultatoIterazioneCalcoloFrazioneContinua = calcolaIesimaFrazione(meno_1, meno_2, a0);
		...
		*/
		if (listaRisultatiAlgoritmoEuclideo.size()!= 0) {
			...
			risultatoIterazioneCalcoloFrazioneContinua = calcolaIesimaFrazione(
					risultatoIterazioneCalcoloFrazioneContinua.get_frazione(),
					meno_1, a1);
			// Aggiungo il risultato alla lista
			listaRisultatiFrazioniContinue
					.add(risultatoIterazioneCalcoloFrazioneContinua);
		}
		...
		for (Iterator<RisultatoIterazioneAlgoritmoEuclideo> iterator = listaRisultatiAlgoritmoEuclideo.iterator(); iterator.hasNext();) {
			...
			risultatoIterazioneCalcoloFrazioneContinua = calcolaIesimaFrazione(risultato_n.get_frazione(), risultato_n_meno_1.get_frazione(), a_n_piu_1);
...
//		
	...
	/**
	 * Metodo per il calcolo del risultato per il calcolo della frazione continua di un numero reale.
	 * 
	 ...
	 */
	private RisultatoIterazioneCalcoloFrazioneContinua calcolaIesimaFrazione(Frazione frazione_n, Frazione frazione_n_meno_1, BigInteger a_n_piu_1) {
